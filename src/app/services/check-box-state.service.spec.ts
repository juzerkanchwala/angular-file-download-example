...
describe('CheckboxStateService', () => {
    ...
    it('should set checked state', () => {
        ...
        const checkedVal = checkBoxStateService.checked$.subscribe(val => expectedResult = val);
    ...
    it('should set intermediate state', () => {
        ...
        const intermediateVal = checkBoxStateService.intermediate$.subscribe(val => expectedResult = val);
    ...
    it('should set selectedItems state', () => {
        let expectedResult = {};
        const data = [{name: 'smss.exe', device: 'Stark', path: '\\System32\\smss.exe', status: 'scheduled'},        
        {name: 'netsh.exe', device: 'Targaryen', path: '\\Windows\\System32\\netsh.exe', status: 'available'}];
       
        checkBoxStateService.selectedItemsState(data);
        const selectedItemsVal = checkBoxStateService.selectedItems$.subscribe(val => expectedResult = val);
