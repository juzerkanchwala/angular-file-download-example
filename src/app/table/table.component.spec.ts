...
describe('TableComponent', () => {
  ...
  it('should call onItemClicked func when an item is clicked and value is present', () => {
    ...
    const onItemClickedSpy = spyOn(component, 'onItemClicked').and.callThrough();
  ...
  it('should call onItemClicked func when an item is clicked and value is not present', () => {
    ...
    const data = {name: 'netsh.exe', device: 'Targaryen', path: '\\Windows\\System32\\netsh.exe', status: 'available'};
  ...
  it('should call updateCheckBoxState when select all is set', () => {
    const updateCheckBoxStateSpy = spyOn(component, 'updateCheckBoxState').and.callThrough();
  ...
  it('should call updateClassName func when item is selected', () => {
    const updateClassNameSpy = spyOn(component, 'updateClassName').and.callThrough();
